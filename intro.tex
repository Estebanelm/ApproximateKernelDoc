...
LIM-06: as the student does not have access to a computer with a middle to high end GPU, the base software
implementation of the CNN is limited to CPU only.

LIM-07: some of the changes to be done on the CNN are changes to the original definition of the network.
