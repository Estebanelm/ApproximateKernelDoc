...
VGG is another succesful CNN which features up to 16 convolution layers, as well
...
Most of the current CNNs in use have a lot of layers for fine tuning the output classification.
